...
(function() {
    ...
    templates['resource'] = template(function(Handlebars, depth0, helpers, partials, data) {
        ...
        buffer += escapeExpression(stack1) + "' data-value=\""+escapeExpression(stack1)+"\" \">/";
        foundHelper = helpers.name;
        stack1 = foundHelper || depth0.name;
        if (typeof stack1 === functionType) {
            stack1 = stack1.call(depth0, {hash: {}});
        ...
        buffer += "'\n     data-option=\"showHide\"          data-value=\""
        foundHelper = helpers.name;
        stack1 = foundHelper || depth0.name;
        if (typeof stack1 === functionType) {
            stack1 = stack1.call(depth0, {hash: {}});
        ...
        buffer += " data-option=\"collapseOperations\" data-value=\""+escapeExpression(stack1)+"\">\n                List Operations\n            </a>\n        </li>\n        <li>\n            <a href='#' ";
        foundHelper = helpers.name;
        stack1 = foundHelper || depth0.name;
        if (typeof stack1 === functionType) {
            stack1 = stack1.call(depth0, {hash: {}});
        ...
        buffer += "data-option=\"expandOperations\" data-value=\""+escapeExpression(stack1) + "\"\">\n                Expand Operations\n            </a>\n        </li>\n        <li>\n            <a href='";
...
(function() {
    ...
    MainView = (function(_super) {
        ...
        MainView.prototype.render = function() {
			...
			$('div .heading > h2 > a').on('click', function() {
				Docs.toggleEndpointListForResource($(this).data('value'));
			});
			$('.options > li > a').on('click', function() {
				switch($(this).data('option')) {
					case "showHide":
						Docs.toggleEndpointListForResource($(this).data('value'));
						break;
					case "collapseOperations":
						Docs.collapseOperationsForResource($(this).data('value'));
						break;
					case "expandOperations":
						Docs.expandOperationsForResource($(this).data('value'));
						break;
				}
			});
            return this;
